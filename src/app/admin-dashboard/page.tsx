...
import EmailTicketCharts from "@/components/admin-dashboard/EmailTicketCharts";
...
const Page = () => {
  ...
  const getFilterList = async () => {
    const params = {
      type: activeTab === 2 ? 24 : dashboardActiveTab === 2 ? 29 : 23,
    };
  ...
  return (
    <WrapperNavbar className="min-h-screen overflow-y-auto">
      ...
      {activeTab === 1 && dashboardActiveTab === 2 && (
        <EmailTicketCharts
          emailboxLoading={emailboxLoading}
          setEmailboxLoading={setEmailboxLoading}
          activeTab={activeTab}
          dashboardActiveTab={dashboardActiveTab}
          currentFilterData={currentFilterData}
        />
