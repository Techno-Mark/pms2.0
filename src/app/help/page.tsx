        ...
        <div className="mt-8 mx-4 px-5 flex flex-col justify-between items-start w-[97%]">
          ...
          <ol className="pl-5 !list-decimal flex flex-col gap-1">
            ...
            <li className="pb-1">
              ...
              on a daily basis at PMS Executable File (.msi). In the event of
            ...
            <li className="pb-1">
              When returning from a break, users must click &apos;OK&apos; on
              the idle time pop-up before clicking the break button again. This
