...
const FilterDialogDashboard = forwardRef(
  (
    {
      activeTab,
      dashboardActiveTab,
    ...
    const [workTypeActive, setWorkTypeActive] = useState<LabelValue | null>(
      null
    );
        ...
        if (ResponseStatus === "Success" && error === false) {
          ...
          if (filteredData.length > 0) {
            ...
            if (dashboardActiveTab === 2) {
              ...
              activeTab === 1
                ? setWorkType(
                    !!data.WorkTypeId && data.WorkTypeId > 0
                      ? data.WorkTypeId
                      : 0
                  )
                : setWorkType(
                  ...
                  >
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      <DatePicker
                        ...
                        maxDate={!!endDate ? dayjs(endDate) : dayjs(Date.now())}
                    ...
                    >
                      <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <DatePicker
                          ...
                          // shouldDisableDate={isWeekend}
                          maxDate={
                            !!endDate ? dayjs(endDate) : dayjs(Date.now())
                          }
                          onChange={(newDate: any) => {
                            setStartDate(newDate.$d);
                          }}
