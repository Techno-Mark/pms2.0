...
const BlackList = ({
  ...
  const getAll = async () => {
    ...
    const url = `${process.env.emailbox_api_url}/emailbox/getBlacklistEntries`;
  ...
  const handleDeleteRow = async () => {
    ...
    const url = `${process.env.emailbox_api_url}/emailbox/deleteBlackListEntry`;
    const successCallback = (
      ResponseData: null,
      error: boolean,
      ResponseStatus: string
  ...
  const column = [
    {
      name: "TypeName",
      label: "Black List Type",
      bodyRenderer: generateCommonBodyRender,
    },
    {
      name: "Value",
      label: "Black List Value",
      bodyRenderer: generateCommonBodyRender,
    },
    {
      name: "actions",
  ...
  const blackListMailColumns = column.map((col: any) => {
          ...
          <>
            ...
            {isDeleteOpen && (
              <DeleteDialog
                ...
                firstContent={
                  "Are you sure you want to delete Black List Email?"
                }
                secondContent={
                  "If you delete Black List Email, you will permanently lose Black List Email and Black List Email related data."
                }
              />
            )}
          </>
